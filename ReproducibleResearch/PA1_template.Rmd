...
plot(stepsByInterval[,1], stepsByInterval[,2], type="l", xlab="Time Interval", ylab="Average Steps", main="Average Steps per Time Interval", lwd=1)
```
...
xyplot(stepsMean ~interval | day ,stepsByDay, type="l", main="Steps per time interval by day type", ylab="Average steps", xlab="Interval")
```